          ...
          <div class="row q-col-gutter-xs">
            <div class="col-12">
              ...
              >
                <template v-slot:error>
                  <q-tooltip>{{ $customT('eventForm.eventNameRequired') }}</q-tooltip>
                </template>
              </q-input>
            </div>
            ...
            <div class="col-12">
              <q-select
                ...
                option-label="name"
                option-value="id"
                :label="$customT('eventForm.status')"
                :rules="[(val) => !!val || $customT('eventForm.statusRequired')]"
                hide-bottom-space
                emit-value
                map-options
                outlined
              >
                <template v-slot:error>
                  <q-tooltip>{{ $customT('eventForm.statusRequired') }}</q-tooltip>
                </template>
              </q-select>
            </div>
            ...
            <div class="col-12">
              ...
              >
                <template v-slot:error>
                  <q-tooltip>{{ $customT('eventForm.courseRequired') }}</q-tooltip>
                </template>
              </q-select>
            </div>
            ...
            <div class="col-12">
              <q-select
                ...
                option-label="name"
                option-value="id"
                :label="$customT('eventForm.category')"
                :rules="[(val) => !!val || $customT('eventForm.categoryRequired')]"
                hide-bottom-space
                emit-value
                map-options
                outlined
              >
                <template v-slot:error>
                  <q-tooltip>{{ $customT('eventForm.categoryRequired') }}</q-tooltip>
                </template>
              </q-select>
            </div>
            ...
            <div class="col-6">
              <q-input
                ...
                :label="$customT('eventForm.startDate')"
                type="date"
                :rules="[(val) => !!val || $customT('eventForm.startDateRequired')]"
                hide-bottom-space
                outlined
              >
                <template v-slot:error>
                  <q-tooltip>{{ $customT('eventForm.startDateRequired') }}</q-tooltip>
                </template>
              </q-input>
            </div>
            ...
            <div class="col-6">
              <q-input
                ...
                :label="$customT('eventForm.endDate')"
                type="date"
                hide-bottom-space
                outlined
              />
            ...
            <div class="col-6">
              <q-input
                ...
                :label="$customT('eventForm.maxPlayers')"
                type="number"
                :rules="[(val) => val > 0 || $customT('eventForm.maxPlayersRequired')]"
                hide-bottom-space
                outlined
              >
                <template v-slot:error>
                  <q-tooltip>{{ $customT('eventForm.maxPlayersRequired') }}</q-tooltip>
                </template>
              </q-input>
            </div>
            ...
            <div class="col-12">
              <q-input
                ...
                :label="$customT('eventForm.description')"
                type="textarea"
                hide-bottom-space
                outlined
                autogrow
            ...
            <div class="col-12">
              ...
              <q-select
                ...
                option-label="name"
                option-value="id"
                :label="$customT('eventForm.moderators')"
                multiple
                emit-value
                map-options
                outlined
